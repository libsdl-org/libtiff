                                 ...
                                 uint64_t *pdiroff)
{
    ...
    while (1)
    {
        ...
        dir = (TIFFDirEntry *)_TIFFmallocExt(tif, (tmsize_t)(ndir * sizeof(TIFFDirEntry)));
        if (dir == NULL)
        {
                                                  ...
                                                  double *value)
{
    ...
    uint32_t i;
    int ok;
    conv = _TIFFmallocExt(tif, (tmsize_t)(count * sizeof(double)));
    if (conv == NULL)
    {
        TIFFErrorExtR(tif, module, "Out of memory");
        return (0);
                                               ...
                                               uint16_t value)
{
    ...
    m = (uint16_t *)_TIFFmallocExt(tif, (tmsize_t)(tif->tif_dir.td_samplesperpixel * sizeof(uint16_t)));
    if (m == NULL)
    {
        TIFFErrorExtR(tif, module, "Out of memory");
        return (0);
                                           ...
                                           uint32_t count, uint64_t *value)
{
    ...
    */
    p = (uint32_t *)_TIFFmallocExt(tif, (tmsize_t)(count * sizeof(uint32_t)));
    if (p == NULL)
    {
        TIFFErrorExtR(tif, module, "Out of memory");
        return (0);
                                            ...
                                            uint32_t count, int64_t *value)
{
    ...
    */
    p = (int32_t *)_TIFFmallocExt(tif, (tmsize_t)(count * sizeof(uint32_t)));
    if (p == NULL)
    {
        TIFFErrorExtR(tif, module, "Out of memory");
        return (0);
                                               ...
                                               uint32_t count, uint64_t *value)
{
    ...
    if (write_aslong4)
    {
        ...
        */
        ...
        uint32_t *p = (uint32_t *)_TIFFmallocExt(tif, (tmsize_t)(count * sizeof(uint32_t)));
        uint32_t *q;
        uint64_t *ma;
        uint32_t mb;
    ...
    {
        uint16_t *p = (uint16_t *)_TIFFmallocExt(tif, (tmsize_t)(count * sizeof(uint16_t)));
        uint16_t *q;
        uint64_t *ma;
        uint32_t mb;
                                         ...
                                         TIFFDirEntry *dir)
{
    ...
    n = (uint16_t *)_TIFFmallocExt(tif, (tmsize_t)(3U * m * sizeof(uint16_t)));
    if (n == NULL)
    {
        TIFFErrorExtR(tif, module, "Out of memory");
        return (0);
    }
    _TIFFmemcpy(&n[0], tif->tif_dir.td_colormap[0], (tmsize_t)(m * sizeof(uint16_t)));
    _TIFFmemcpy(&n[m], tif->tif_dir.td_colormap[1], (tmsize_t)(m * sizeof(uint16_t)));
    _TIFFmemcpy(&n[2 * m], tif->tif_dir.td_colormap[2], (tmsize_t)(m * sizeof(uint16_t)));
                                                 ...
                                                 TIFFDirEntry *dir)
{
    ...
    o = (uint16_t *)_TIFFmallocExt(tif, (tmsize_t)(n * m * sizeof(uint16_t)));
    if (o == NULL)
    {
        TIFFErrorExtR(tif, module, "Out of memory");
        return (0);
                                       ...
                                       TIFFDirEntry *dir)
{
    ...
    if (!(tif->tif_flags & TIFF_BIGTIFF))
    {
        ...
        uint32_t *pb;
        uint16_t p;
        o = (uint32_t *)_TIFFmallocExt(tif, (tmsize_t)(tif->tif_dir.td_nsubifd * sizeof(uint32_t)));
        if (o == NULL)
        {
            TIFFErrorExtR(tif, module, "Out of memory");
            return (0);
                                                     ...
                                                     float *value)
{
    ...
    m = (uint32_t *)_TIFFmallocExt(tif, (tmsize_t)(count * 2 * sizeof(uint32_t)));
    if (m == NULL)
    {
        TIFFErrorExtR(tif, module, "Out of memory");
        return (0);
                                                      ...
                                                      float *value)
{
    ...
    m = (int32_t *)_TIFFmallocExt(tif, (tmsize_t)(count * 2 * sizeof(int32_t)));
    if (m == NULL)
    {
        TIFFErrorExtR(tif, module, "Out of memory");
        return (0);
